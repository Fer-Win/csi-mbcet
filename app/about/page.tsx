...
const About = () => {
  return (
    <div className='pt-48 pb-20 md:py-24 px-10 md:px-24'>
      <div>
        ...
        <div className='flex flex-col justify-start text-2xl font-bold rounded-md py-4 px-4  items-start bg-white text-black'>
          We are committed to:
